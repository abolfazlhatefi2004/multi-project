...
const Card = ({ cardIfoContainer }: PropsType): ReactElement => {
    ...
    return (
        <Link to={cardIfoContainer.linkAddress} className='md:w-[500px] w-[300px] h-[95%]  p-10 border border-gray-100 dark:border-black rounded-2xl shadow-xl dark:shadow-dxl bg-white dark:bg-gray-900 dark:text-white group relative flex flex-col justify-between' 
        dir={isEnglish ? 'ltr' : 'rtl'}>
            ...
            <div className='z-10 flex flex-col items-center'>
                ...
                <h3 className='w-full font-bold text-3xl capitalize py-5'>{cardIfoContainer.title}</h3>
            </div>
